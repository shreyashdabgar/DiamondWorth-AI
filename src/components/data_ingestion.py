...
class dataingestionconfig():
    train_data_path = os.path.join('artificats', "train.csv") #basically this is we assigning the path of the where to store train.csv file
    test_data_path  = os.path.join('artificats', "test.csv") #basically this is we assigning the path of the where to store test.csv file
    raw_data_path = os.path.join('artificats', "data.csv") #basically this is we assigning the path of the where to store data.csv(full data)
